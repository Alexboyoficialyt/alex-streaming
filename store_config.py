...
PRODUCTS.extend([
    {
        ...
        "category": "Free Fire",
        "badge": "DIAMANTES",
        "description": "Recargas de diamantes con bonificación según el paquete seleccionado.",
        "plans": [
            {"name": "100 + 10 · Paquete 110", "price": 2.89},
            {"name": "310 + 31 · Paquete 341", "price": 8.29},
            {"name": "520 + 52 · Paquete 572", "price": 13.59},
            {"name": "1060 + 106 · Paquete 1166", "price": 24.59},
            {"name": "2180 + 218 · Paquete 2398", "price": 48.90},
            {"name": "5600 + 560 · Paquete 6160", "price": 123.89},
        ],
        "details": [
            "100 + 10 = paquete total 110.",
            "310 + 31 = paquete total 341.",
            "520 + 52 = paquete total 572.",
            "1060 + 106 = paquete total 1166.",
            "2180 + 218 = paquete total 2398.",
            "5600 + 560 = paquete total 6160.",
        ],
        "notes": [
            "Los precios mostrados están configurados en soles peruanos (PEN).",
    ...
    },
    {
        ...
        "category": "Free Fire",
        "badge": "MEMBRESÍA",
        "description": "Membresías básica, semanal y mensual.",
        "plans": [
            {"name": "Membresía básica · Paquete básica", "price": 1.69},
            {"name": "Membresía semanal · Paquete semanal", "price": 5.89},
            {"name": "Membresía mensual · Paquete mensual", "price": 27.90},
        ],
        "details": [
            "Membresía básica: S/ 1.69.",
            "Membresía semanal: S/ 5.89.",
            "Membresía mensual: S/ 27.90.",
        ],
    ...
    },
    {
        ...
        "plans": [
            {"name": "Pase Booyah · Paquete booyah", "price": 8.39},
        ],
        "details": [
            "Pase Booyah: S/ 8.39.",
            "Entrega y activación coordinadas por WhatsApp."
        ],
        "notes": [],
        "logo_url": "",
        "logo_class": "",
    ...
    {
        "id": "freefire-extras",
        "name": "Free Fire · Extras",
        "icon": "lucide:box",
        "accent": "#FF8A17",
        "category": "Free Fire",
        "badge": "EXTRAS",
        "description": "Pase, fragmentos, cajas y membresía semanal en opciones adicionales.",
        "plans": [
            {"name": "Pase Booyah · Promo · antes S/ 4.00", "price": 3.60},
            {"name": "Fragmentos · Desde", "price": 18.00},
            {"name": "Cajas de Tokens Evo Universales · Desde", "price": 18.00},
            {"name": "Membresía semanal · Promo · antes S/ 7.00", "price": 6.00},
        ],
        "details": [
            "Pase Booyah promocional: S/ 3.60.",
            "Fragmentos: desde S/ 18.00.",
            "Cajas de Tokens Evo Universales: desde S/ 18.00.",
            "Membresía semanal promocional: S/ 6.00.",
        ],
        "notes": [
            "Los valores promocionales corresponden a la referencia visual proporcionada."
        ],
        "logo_url": "",
        "logo_class": "",
        "display_name": "Free Fire Extras",
    },
])
