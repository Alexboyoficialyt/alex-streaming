...
PAYMENT_METHODS = [{'id': 'yape',
  ...
  'account': '918532738',
  'holder': 'TEDDY',
  'instructions': 'Yape no está disponible temporalmente. Selecciona Plin, BCP o Binance.'},
 {'id': 'plin',
  'name': 'Plin',
...
# ============================================================
# V109 — ACCESO DIRECTO + FREE FIRE ACTUALIZADO
# ============================================================

STORE["registration_required"] = False

# Reemplazar cualquier versión anterior de la categoría Free Fire.
_FREE_FIRE_IDS = {
    "freefire-diamantes",
    "freefire-membresias",
...
PRODUCTS.extend([
    {
        ...
        "category": "Free Fire",
        "badge": "DIAMANTES",
        "description": "Recargas de diamantes Free Fire con bonificación incluida según el paquete.",
        "plans": [
        ...
        "notes": [
            ...
            "La entrega se coordina por WhatsApp."
        ],
        "logo_url": "",
        "logo_class": "",
    ...
    },
    {
        ...
        "logo_url": "",
        "logo_class": "",
        "display_name": "Free Fire Membresía Mensual",
    },
    {
        ...
        "notes": ["Entrega coordinada por WhatsApp."],
        "logo_url": "",
        "logo_class": "",
    ...
    },
    {
        ...
        "category": "Free Fire",
        "badge": "FRAGMENTOS",
        "description": "Paquetes de fragmentos para Free Fire.",
        "plans": [
